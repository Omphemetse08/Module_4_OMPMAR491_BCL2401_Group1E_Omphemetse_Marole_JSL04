...
let WorkoutIntensity =
  heartRate < 100 ? `Boost needed!` : "Energy level are high!";
...
let TemeperatureSuitability =
  currentTemp <= 5 ? `Chilled to perfection!` : "need a cooler!";
console.log(TemeperatureSuitability);
